...
void StartScene::update()
{
	...
	//TODO: implement AABBCheck(m_pShip, m_pPlanet);
	//TODO: implement AABBCHeck(m_pShip, m_pMine);
...
void StartScene::m_move()
{
	...
	m_position = m_pShip->getPosition() + m_velocity * m_speed; // +m_acceleration;
	m_pShip->setPosition(m_position);
}
